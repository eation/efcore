...
{
    /// <inheritdoc/>
    public class SqlServerSharedTypeEntityExpansionHelper : SharedTypeEntityExpansionHelper
    {
        /// <summary>
        ...
        /// </summary>
        public SqlServerSharedTypeEntityExpansionHelper(SharedTypeEntityExpansionHelperDependencies dependencies)
            : base(dependencies)
        {
        }

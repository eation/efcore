...
namespace Microsoft.EntityFrameworkCore.Query
{
    ...
    public class TemporalOwnedEntityMappedToDifferentTableSqlServerTest : NonSharedModelTestBase
    {
        protected override string StoreName => "TemporalOwnedEntityMappedToDifferentTableTest";
...
ORDER BY [t0].[Id] DESC");
        ...
        [ConditionalFact]
        public virtual async Task Temporal_owned_range_operation_negative()
        {
            var contextFactory = await InitializeAsync<MyContext26451>();
            using (var context = contextFactory.CreateContext())
            {
